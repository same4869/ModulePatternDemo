...
public class ViewUtil {
    ...
    public static int dp2px(float dp){
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, MyApp.getInstance().getResources().getDisplayMetrics());
    }

    public static float px2dp(float px){
        return px/ MyApp.getInstance().getResources().getDisplayMetrics().density;
    }

    public static float sp2px(float sp){
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, sp, MyApp.getInstance().getResources().getDisplayMetrics());
    }

    public static float px2sp(float px){
        return px/MyApp.getInstance().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static void requestInputMethodIfShow(final EditText view){
        final InputMethodManager imm= (InputMethodManager) MyApp.getInstance().getSystemService(Context.INPUT_METHOD_SERVICE);
        if(imm.isActive()) {
            view.requestFocus();
